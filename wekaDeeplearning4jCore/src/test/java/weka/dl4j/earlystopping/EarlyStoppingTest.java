...
public class EarlyStoppingTest {
     ...
     */
    public void testConfig(int maxEpochs, int maxEpochsNoImprovement,
                           double validationSplit) throws Exception {
