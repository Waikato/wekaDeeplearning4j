...
java -Xmx5g -cp ${WEKA_HOME}/weka.jar weka.Run \
     .Dl4jMlpClassifier \
     -S 1 \
     -iterator "weka.dl4j.iterators.ImageDataSetIterator -height 28 -imagesLocation ../wekaDeeplearning4jCore/datasets/nominal/mnist-minimal -numChannels 1 -bs 128 -width 28" \
