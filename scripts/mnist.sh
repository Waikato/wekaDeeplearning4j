...
java -Xmx5g -cp ${WEKA_HOME}/weka.jar weka.Run \
	 ...
	 -iterator "weka.dl4j.iterators.instance.ImageInstanceIterator -height 28 -width 28 -imagesLocation ../wekaDeeplearning4jCore/src/test/resources/nominal/mnist-minimal -numChannels 1 -bs 32 " \
