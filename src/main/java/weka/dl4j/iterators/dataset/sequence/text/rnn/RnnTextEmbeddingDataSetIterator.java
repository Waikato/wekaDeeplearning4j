...
public class RnnTextEmbeddingDataSetIterator implements DataSetIterator, Serializable {
     ...
     * create the tokens and filters based on whether the
     * {@link RnnTextEmbeddingDataSetIterator#wordVectors} model contains the token and further
     * filters based on the given {@link RnnTextEmbeddingDataSetIterator#stopWords}.
     *
